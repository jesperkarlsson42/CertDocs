# SC-200 Implementation Guides

Step-by-step implementation guides with visual flows for key SC-200 topics.

| Guide | Description |
|-------|------------|
| [AIR – Automated Investigation & Response](implementations/air-automated-investigation.md) | Automated investigation and remediation via Defender XDR integrated with Sentinel |
